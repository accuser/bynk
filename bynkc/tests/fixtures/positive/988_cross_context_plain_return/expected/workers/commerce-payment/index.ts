      ...
      if (path.startsWith("/_bynk/call/")) {
        ...
        switch (servicePath) {
          case "authorise": {
            ...
            if (__contract !== "da78d5301d8df299") return new Response(JSON.stringify({ kind: "ContractMismatch", service: "authorise", expected: "da78d5301d8df299", actual: __contract }), { status: 409, headers: { "content-type": "application/json" } });
