      ...
      if (path.startsWith("/_bynk/call/")) {
        ...
        switch (servicePath) {
          case "pay": {
            ...
            if (__contract !== "a5ade10cd4426ad3") return new Response(JSON.stringify({ kind: "ContractMismatch", service: "pay", expected: "a5ade10cd4426ad3", actual: __contract }), { status: 409, headers: { "content-type": "application/json" } });
            ...
            const body = handlers.serialise_Receipt(result);
