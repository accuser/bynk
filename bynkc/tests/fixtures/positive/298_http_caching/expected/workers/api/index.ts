    ...
    try {
      ...
      }
      {
        if ((method === "GET" || method === "HEAD") && path === "/config") {
          ...
          const __response = applySecurityHeaders(applyCors(notModifiedIfMatch(applyCache(httpResultToResponse(result, (__v: string) => __v as JsonValue, { weakEtag: true }), 300, "public"), request), __cors_api, request.headers.get("origin")), __security_api);
      ...
      }
      {
        if ((method === "GET" || method === "HEAD") && path === "/edge") {
          ...
          const __response = applySecurityHeaders(applyCors(notModifiedIfMatch(applyCache(httpResultToResponse(result, (__v: string) => __v as JsonValue, { weakEtag: true }), 1, "private"), request), __cors_api, request.headers.get("origin")), __security_api);
          return method === "HEAD" ? headResponse(__response) : __response;
        }
      }
      {
      ...
      }
      {
        if ((method === "GET" || method === "HEAD") && path === "/private") {
          ...
          const __response = applySecurityHeaders(applyCors(notModifiedIfMatch(applyCache(httpResultToResponse(result, (__v: string) => __v as JsonValue, { weakEtag: true }), 30, "private"), request), __cors_api, request.headers.get("origin")), __security_api);
          return method === "HEAD" ? headResponse(__response) : __response;
        }
      }
      {
        if ((method === "GET" || method === "HEAD") && path === "/ticks") {
          ...
          const __response = applySecurityHeaders(applyCors(notModifiedIfMatch(httpResultToResponse(result, (__v: void) => null, { weakEtag: true }), request), __cors_api, request.headers.get("origin")), __security_api);
          return method === "HEAD" ? headResponse(__response) : __response;
        }
      }
      {
