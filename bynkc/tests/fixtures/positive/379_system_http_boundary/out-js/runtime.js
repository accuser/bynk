...
exports.responseToHttpResult = responseToHttpResult;
...
async function responseToHttpResult(response, deserialiseValue) {
    ...
    switch (tag) {
        ...
        case "Accepted": {
            ...
            const value = (decoded.tag === "Ok" ? decoded.value : json);
            return { tag, value };
        }
        case "MovedPermanently":
        case "Found":
