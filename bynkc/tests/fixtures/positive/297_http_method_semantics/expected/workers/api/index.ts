    ...
    try {
...

      {
        if ((method === "GET" || method === "HEAD") && path === "/logo") {
          ...
          const __response = applySecurityHeaders(notModifiedIfMatch(httpResultToResponse(result, (__v: void) => null, { weakEtag: true }), request), __security_routes);
      ...
      }
      {
        if (method === "POST" && path === "/notes") {
          ...
          return applySecurityHeaders(httpResultToResponse(result, (__v: string) => __v as JsonValue), __security_routes);
        }
      }
      {
