      ...
      if (path.startsWith("/_bynk/call/")) {
        ...
        switch (servicePath) {
          case "run": {
            ...
            if (__contract !== "f5593d281dec8283") return new Response(JSON.stringify({ kind: "ContractMismatch", service: "run", expected: "f5593d281dec8283", actual: __contract }), { status: 409, headers: { "content-type": "application/json" } });
