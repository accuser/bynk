...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    try {
      ...
      if (method === "OPTIONS" && request.headers.get("access-control-request-method") !== null && (path === "/a\\b\\" || matchPath("/c\\d/:id", path) !== null)) {
      ...
      {
        const __m = matchPath("/c\\d/:id", path);
