      ...
      if (path.startsWith("/_bynk/call/")) {
        ...
        switch (servicePath) {
          case "authorise": {
            ...
            if (__contract !== "e32eb3baff10120b") return new Response(JSON.stringify({ kind: "ContractMismatch", service: "authorise", expected: "e32eb3baff10120b", actual: __contract }), { status: 409, headers: { "content-type": "application/json" } });
