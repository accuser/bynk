      ...
      if (path.startsWith("/_bynk/call/")) {
        ...
        switch (servicePath) {
          case "ping": {
            ...
            if (__contract !== "515b74f52710084e") return new Response(JSON.stringify({ kind: "ContractMismatch", service: "ping", expected: "515b74f52710084e", actual: __contract }), { status: 409, headers: { "content-type": "application/json" } });
