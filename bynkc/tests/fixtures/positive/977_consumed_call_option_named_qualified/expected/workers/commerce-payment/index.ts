      ...
      if (path.startsWith("/_bynk/call/")) {
        ...
        switch (servicePath) {
          case "authorise": {
            ...
            if (__contract !== "aee5199bfc118568") return new Response(JSON.stringify({ kind: "ContractMismatch", service: "authorise", expected: "aee5199bfc118568", actual: __contract }), { status: 409, headers: { "content-type": "application/json" } });
            ...
            const result = await surface.authorise(id);
