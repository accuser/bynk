      ...
      if (path.startsWith("/_bynk/call/")) {
        ...
        switch (servicePath) {
          case "hello": {
            ...
            if (__contract !== "378d7d423042f066") return new Response(JSON.stringify({ kind: "ContractMismatch", service: "hello", expected: "378d7d423042f066", actual: __contract }), { status: 409, headers: { "content-type": "application/json" } });
