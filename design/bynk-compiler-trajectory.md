...
| 6 | [`the-ir.md`](tracks/the-ir.md) | Settling (spine [#1137](https://github.com/accuser/bynk/issues/1137)) — its settling draft PR argues six open design questions, including that this phase does not build the reference's own `bynk-ir`/`bynk-lower` crates (Part 10), deferred to phase 7 |
| 7 | *(to be opened)* | — |
| 8 | *(to be opened)* | — |
