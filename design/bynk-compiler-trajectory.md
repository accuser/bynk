...
| 4 | [`project-model.md`](tracks/project-model.md) | **Settled — Slicing on merge** (settled 6 August 2026; spine [#1107](https://github.com/accuser/bynk/issues/1107), settling PR [#1108](https://github.com/accuser/bynk/pull/1108)). All six design questions closed; contract hashing and the typed `ProjectGraph` deferred to phase 8; R10.2 closes via a new, narrow `bynk-check` analysis entry point rather than relocating `bynk-emit`'s shared discovery-and-checking orchestration, with the resulting duplication named as phase 5's to remove |
| 5 | *(to be opened)* | — |
| 6 | *(to be opened)* | — |
| 7 | *(to be opened)* | — |
| 8 | *(to be opened)* | — |
