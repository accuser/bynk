...
| `verbatim_sites` | yes | 7 |
| `wildcard_arms` | no (trend) | 317 |
| `keep_in_sync` | no (trend) | 217 |
| `test_density` | no (trend) | bynk=13.6%, bynk-check=9.2%, bynk-driver=22.3%, bynk-emit=23.5%, bynk-fmt=15.6%, bynk-grammar=33.2%, bynk-ide=40.9%, bynk-lsp=35.7%, bynk-project=33.6%, bynk-render=41.8%, bynk-strip=53.5%, bynk-syntax=10.7%, bynk-testkit=0.0%, bynk-ts=52.7%, bynk-wasm=45.1%, bynkc=0.0%, xtask=37.6% |
