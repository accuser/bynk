...
| `emit_diagnostics` | yes | bynk-emit=6/8, bynk-check=386/394 (true/naive) |
| `ide_emit_edge` | yes | absent |
| `ast_importers` | yes | 10 |
| `emit_abi_shapes` | yes | 1 (bynk-cloudflare.ts:negotiateLocale) |
| `wildcard_arms` | no (trend) | 295 |
| `keep_in_sync` | no (trend) | 156 |
| `test_density` | no (trend) | bynk=13.7%, bynk-check=8.3%, bynk-driver=22.3%, bynk-emit=8.5%, bynk-fmt=15.6%, bynk-grammar=33.2%, bynk-ide=40.9%, bynk-lsp=35.7%, bynk-project=34.0%, bynk-render=41.8%, bynk-strip=41.5%, bynk-syntax=10.7%, bynk-testkit=0.0%, bynk-wasm=45.2%, bynkc=0.0%, xtask=34.1% |
| `fixture_kinds` | no (trend) | contains=3, absent=2, diagnostics=5, error=422 |
