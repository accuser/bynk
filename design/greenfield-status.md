...
| `fs_below_driver` | yes | 4 files (bynk-emit=2, bynk-ide=2, bynk-fmt=0) |
| `options_sources` | yes | present |
| `hoist_sinks` | yes | 0 |
| `span_keyed_maps` | yes | 3 |
| `emit_diagnostics` | yes | bynk-emit=201/206, bynk-check=206/212 (true/naive) |
...
| `keep_in_sync` | no (trend) | 148 |
| `test_density` | no (trend) | bynk=13.7%, bynk-check=9.0%, bynk-driver=20.4%, bynk-emit=8.5%, bynk-fmt=15.6%, bynk-grammar=33.2%, bynk-ide=41.3%, bynk-lsp=34.8%, bynk-render=41.8%, bynk-strip=41.5%, bynk-syntax=10.7%, bynk-wasm=45.2%, bynkc=0.0%, xtask=33.6% |
