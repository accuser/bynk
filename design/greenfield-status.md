...
| `emit_diagnostics` | yes | bynk-emit=25/27, bynk-check=370/378 (true/naive) |
...
| `keep_in_sync` | no (trend) | 154 |
| `test_density` | no (trend) | bynk=13.7%, bynk-check=8.5%, bynk-driver=22.3%, bynk-emit=7.9%, bynk-fmt=15.6%, bynk-grammar=33.2%, bynk-ide=40.9%, bynk-lsp=35.7%, bynk-project=34.0%, bynk-render=41.8%, bynk-strip=41.5%, bynk-syntax=10.7%, bynk-testkit=0.0%, bynk-wasm=45.2%, bynkc=0.0%, xtask=34.1% |
