...
| `incremental_query_types` | yes | query_types 2/4 (UnitSignature, ProjectGraph); shared_cache not migrated (PROJECT_UNIT_CACHE still bynk-ide-local); stability_test present |
| `wildcard_arms` | no (trend) | 320 |
| `keep_in_sync` | no (trend) | 235 |
| `test_density` | no (trend) | bynk=13.6%, bynk-check=9.7%, bynk-driver=22.3%, bynk-emit=11.8%, bynk-fmt=15.6%, bynk-grammar=33.2%, bynk-ide=40.9%, bynk-ir=0.0%, bynk-lower=66.6%, bynk-lsp=35.7%, bynk-project=33.6%, bynk-render=41.8%, bynk-strip=53.5%, bynk-syntax=10.7%, bynk-testkit=0.0%, bynk-ts=59.6%, bynk-wasm=45.1%, bynkc=0.0%, xtask=39.4% |
