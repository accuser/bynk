...
| `test_density` | no (trend) | bynk=13.7%, bynk-check=9.0%, bynk-driver=20.8%, bynk-emit=8.5%, bynk-fmt=15.6%, bynk-grammar=33.2%, bynk-ide=41.3%, bynk-lsp=34.8%, bynk-render=41.8%, bynk-strip=41.5%, bynk-syntax=10.7%, bynk-wasm=45.2%, bynkc=0.0%, xtask=33.6% |
