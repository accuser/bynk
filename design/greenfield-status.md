...
| `test_density` | no (trend) | bynk=13.7%, bynk-check=9.2%, bynk-driver=22.3%, bynk-emit=24.0%, bynk-fmt=15.6%, bynk-grammar=33.2%, bynk-ide=40.9%, bynk-lsp=35.7%, bynk-project=33.6%, bynk-render=41.8%, bynk-strip=41.5%, bynk-syntax=10.7%, bynk-testkit=0.0%, bynk-wasm=45.2%, bynkc=0.0%, xtask=36.6% |
