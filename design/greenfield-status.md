...
| `test_density` | no (trend) | bynk=13.8%, bynk-check=8.5%, bynk-driver=14.4%, bynk-emit=8.5%, bynk-fmt=15.6%, bynk-grammar=33.2%, bynk-ide=41.6%, bynk-lsp=34.9%, bynk-render=41.8%, bynk-strip=41.5%, bynk-syntax=10.7%, bynk-wasm=45.1%, bynkc=0.0%, xtask=33.6% |
