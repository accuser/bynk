...
| `keep_in_sync` | no (trend) | 239 |
| `test_density` | no (trend) | bynk=13.6%, bynk-check=10.4%, bynk-driver=22.3%, bynk-emit=11.8%, bynk-fmt=15.6%, bynk-grammar=33.2%, bynk-ide=41.0%, bynk-ir=0.0%, bynk-lower=66.6%, bynk-lsp=35.7%, bynk-project=37.4%, bynk-render=41.8%, bynk-strip=53.5%, bynk-syntax=10.7%, bynk-testkit=0.0%, bynk-ts=59.6%, bynk-wasm=45.1%, bynkc=0.0%, xtask=39.4% |
