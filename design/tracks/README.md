...
| [`content-ownership.md`](content-ownership.md) | [#1086](https://github.com/accuser/bynk/issues/1086) | Slicing (slices 0–2 shipped, #1089/#1092/#1094) | `bynk-lsp` becomes the sole reader of `.bynk` source content — realises R2.3's `fs_below_driver` probe for `bynk-emit`/`bynk-ide` |
