...
| [`deploy.md`](deploy.md) | [#558](https://github.com/accuser/bynk/issues/558) | Slicing (0–4 shipped; 5 remaining) | The `bynk deploy` verb: provisioning + remote deploy, and the load-bearing provisioning-state model |
