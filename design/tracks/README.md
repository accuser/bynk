...
| [`lsp-foundations.md`](lsp-foundations.md) | [#640](https://github.com/accuser/bynk/issues/640) | Slicing (slices 0, A, B, C shipped) | The foundation under the shipped LSP surface: one project model shared with `bynkc`, a freshness contract, the lifecycle, and the test seam that makes all three testable |
