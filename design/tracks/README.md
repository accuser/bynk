...
| [`content-ownership.md`](content-ownership.md) | [#1086](https://github.com/accuser/bynk/issues/1086) | Slicing (slices 0–3 shipped, #1089/#1092/#1094/#1096; slice 4 in progress, #1098) | `bynk-lsp` becomes the sole reader of `.bynk` source content — realises R2.3's `fs_below_driver` probe for `bynk-emit`/`bynk-ide` |
