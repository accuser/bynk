...
- **Track:** `design/tracks/storage.md` (§3 Q6/Q7 — the second of the two non-kind items left before the track retires; the parity slice, [ADR 0123](0123-state-block-cutover-and-codemod.md), was the first). This ADR **settles** the policy; the **rehydration slice** builds the gate (D5).
