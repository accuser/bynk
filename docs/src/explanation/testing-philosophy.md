...
`Matches`-refined type is rejected ([`karn.mock.needs_pin`](../how-to/troubleshooting/mock-errors.md))
...
- How-to: [Write tests and mock collaborators](../how-to/testing/write-tests.md).
