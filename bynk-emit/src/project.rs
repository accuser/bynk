    ...
    match target {
        ...
        BuildTarget::Workers => {
            ...
            for (ctx_name, kind) in &kinds {
                ...
                let own_contracts = own_contract_hashes(ctx_name, table, &own_types);
