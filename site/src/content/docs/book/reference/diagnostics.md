...
| `bynk.generics.generic_record_at_boundary` | A generic record instantiation appears in a serialised position (handler signature, agent store, record field, or codec target); generic records are non-boundary in v0.157 (ADR 0183). |  |
